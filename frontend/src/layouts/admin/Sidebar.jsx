...
import { X, Home, Users, ShoppingCart, BarChart3, Settings, FileText, File } from 'lucide-react';

const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  const [openSubmenus, setOpenSubmenus] = useState({}); // track submenu open/close
